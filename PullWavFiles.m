function PullWavFiles(DATE)
  ...
  %% PATHS:
  START_DIR_ROOT = '/Volumes/recording'; % Recording room computer, where all the main folders are kept.
  ...
  WAV_path = strcat(START_DIR_ROOT,'/',int2str(BOX_ID(i)),'-WAV');
  IMG_path = strcat(START_DIR_ROOT,'/',int2str(BOX_ID(i)),'-IMG');
